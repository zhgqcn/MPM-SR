...
def checkpoint(epoch):
    model_out_path = "/kaggle/working/LapSRN_model_epoch_g_{}.pth".format(epoch)
...
for epoch in range(1, opt.nEpochs + 1):
    ...
    if epoch % 10 == 0:
        ...
        data_frame_val.to_csv('/kaggle/working/result-g-val.csv', index_label='Epoch')
        k = k + 1
    ...
    data_frame_train.to_csv('/kaggle/working//result-g-train.csv', index_label='Epoch')
