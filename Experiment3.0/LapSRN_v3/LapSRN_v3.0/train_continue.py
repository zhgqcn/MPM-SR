...
parser.add_argument('--pre_model_g', type=str, default='./r.pt', help='continue train model : load r model')
...
if os.path.exists(opt.pre_model_r):
    ...
    for epoch in range(epoch_continue_g + 1, opt.nEpochs + 1):
        ...
        index=range(epoch_continue_g + 1,epoch + 1))
