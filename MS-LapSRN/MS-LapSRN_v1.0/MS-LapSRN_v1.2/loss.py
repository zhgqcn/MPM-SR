...
class Loss(nn.Module):
    def __init__(self):
        ...
        loss_network = nn.Sequential(*list(vgg.features)[:31]).eval() #https://blog.csdn.net/qq_34108714/article/details/90400195
    ...
    def forward(self, out_images, target_images):
        ...
        ssim_loss = SSIM_loss(out_images, target_images)
        return image_loss + 1e-8 * perception_loss + 0.5 * ssim_loss
