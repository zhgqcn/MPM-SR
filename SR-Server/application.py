...
global model_g
global model_r
model_r = LapSRN(5, 5, 4)
model_g = LapSRN(5, 5, 4)
...
model_r, optimizer_r, epochs_r = load_model(model_r, optimizer_r, 'MSLapSRN_model_epoch_r_250.pth')
model_g, optimizer_g, epochs_g = load_model(model_g, optimizer_g, 'MSLapSRN_model_epoch_g_250.pth')
    ...
    if request.method == 'POST':
        ...
        if image_file:
            ...
            if not os.path.exists(image_location):
                ...
                output_location_x2 = os.path.join(OUTPUT_FOLDER + '/X2', image_file.filename)
                output_location_x4 = os.path.join(OUTPUT_FOLDER + '/X4', image_file.filename)
